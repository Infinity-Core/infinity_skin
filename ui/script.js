$(document).ready(function(){
  ...
  $('input').change(function(){
	  let char_sex = $('input[name=sex]:checked', '#formSkinCreator').val()
	  if(char_sex == 1){
    ...
    $.post('https://infinity_skin/updateBody', JSON.stringify({
      value: false,
      // Body
  ...
  $('.yes').on('click', function(e){
    e.preventDefault();
    $.post('https://infinity_skin/saveSkin', JSON.stringify(
    {
      NewCaracter: event.data.EntityNew,
      value: true,
      sex: $('input[name=sex]:checked', '#formSkinCreator').val(),
      skincolor: $('input[name=skincolor]:checked', '#formSkinCreator').val(),
      eyecolor: $('input[name=eyecolor]:checked','#formSkinCreator').val(),
  ...
  $(document).keypress(function(e) {
        if (e.which == 113) { // Q pressed
            $.post('https://infinity_skin/heading', JSON.stringify({
                value: -10
            }));
        }
        if (e.which == 120) { // x pressed
            $.post('https://infinity_skin/defcam');
        }
		...
		if (e.which == 119) { // w pressed
            $.post('https://infinity_skin/camera', JSON.stringify({
                offset: 0.05
            }));
        }
